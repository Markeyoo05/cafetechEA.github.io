function buyNow(productid,productprice,quantityseller,productname) {
    var quantityInput = document.getElementById(productid);
    var priceElement = document.getElementById(productprice);
    var quantitySellerElement = document.getElementById(quantityseller);
    var product3NameElement = document.getElementById(productname);
    ...
    if (PaymentMethod == 'gcash') {
        ...
        var userDetails = {
            ...
            allDetails += "Product Name: "+product3NameElement.textContent+"\n";
